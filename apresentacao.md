...
**Duração total:** 20 minutos | **21 slides** | **~57 s por slide** (média)

> Cada seção corresponde a um slide (`slides/pagina1.html` a `pagina21.html`). Cada slide traz duas versões: **Texto (20 min)** — versão calibrada para a apresentação oral — e **Texto expandido** — versão mais detalhada para estudo, ensaio e aprofundamento na defesa.
...
## Slide 19 — Considerações Finais: Síntese ⏱ ~45 s

**Texto (20 min)**

Em síntese, investigamos a espaciabilidade como orientação para mapeamento urbano colaborativo, concebendo o Mapa Cidadão como artefato cognitivo. Os achados positivos incluem apoio à orientação e localização — D1 — e identificação inicial de padrões via marcadores. As direções futuras são filtros, agregação e visualização analítica — D2 e D4 — e simbologia aprimorada — D6. Como destaco no slide: dados georreferenciados por si só não promovem compreensão territorial — é preciso avançar em ferramentas analíticas em plataformas de mapeamento colaborativo urbano.
...
## Slide 20 — Considerações Finais: Limitações ⏱ ~40 s

**Texto (20 min)**

Reconheço quatro limitações deste estudo preliminar: amostra reduzida de três especialistas, restringindo generalização; avaliadores do mesmo laboratório de IHC; Mapa Cidadão em estágio inicial, sem filtros ou agregação implementados; e perspectiva exclusiva de especialistas, sem usuários finais nem gestores públicos. Essas limitações delimitam o escopo e orientam investigações futuras, sem invalidar os achados.

**Texto expandido**

Reconheço as limitações desta pesquisa, apresentadas como estudo preliminar. **01 — Amostra reduzida:** avaliação com apenas três especialistas, restringindo a generalização dos resultados em um estudo exploratório e qualitativo. **02 — Perfil dos participantes:** avaliadores do mesmo laboratório de IHC, o que pode influenciar convergências e limitar a diversidade de perspectivas. **03 — Maturidade do sistema:** Mapa Cidadão em estágio inicial, sem funcionalidades analíticas avançadas — filtros e agregação ainda não implementados na versão avaliada. **04 — Escopo da avaliação:** perspectiva exclusiva de especialistas, não contemplando usuários finais nem gestores públicos — perfis centrais para o uso real de tecnologias cívicas. Essas limitações não invalidam os achados, mas delimitam seu escopo e orientam investigações futuras com amostras maiores, funcionalidades analíticas e múltiplos perfis de usuário.

---

## Slide 21 — Considerações Finais: Contribuições ⏱ ~50 s

**Texto (20 min)**

As contribuições são: consolidação da espaciabilidade como critério aplicável; aplicação empírica do MIE com recomendações estruturadas — tarefas analíticas, relatórios mistos e rótulos de categorização; desenvolvimento do Mapa Cidadão voltado à interpretação espacial; e evidências sobre a interdependência entre espaciabilidade, usabilidade e UX em tecnologias cívicas. A mensagem central: em plataformas baseadas em mapas, a qualidade da representação espacial é fundamental para transformar dados colaborativos em compreensão territorial e suporte à tomada de decisão. Agradeço à orientadora Marcelle, ao coorientador André, aos membros da banca e a todos que contribuíram. Estou à disposição para perguntas.

**Texto expandido**

As principais contribuições deste trabalho são quatro. Primeiro, a consolidação da espaciabilidade como critério aplicável ao design de sistemas colaborativos urbanos — demonstrando que o conceito pode orientar decisões de projeto desde a concepção e complementa, sem substituir, usabilidade, UX, acessibilidade e comunicabilidade. Segundo, a aplicação empírica do MIE, estendendo o estudo de caso original do Google Maps: três avaliadores, recomendações estruturadas — tarefas analíticas mais robustas, relatórios em formato misto e rótulos de categorização. Terceiro, o desenvolvimento do Mapa Cidadão, sistema concebido explicitamente para apoiar a interpretação espacial das ocorrências, e não apenas seu registro pontual. Quarto, evidências qualitativas sobre a interdependência entre espaciabilidade, usabilidade e experiência do usuário em tecnologias cívicas — reforçando a ponte teórica entre critérios de IHC, pensamento espacial medido pelo STAT e design de mapas digitais proposta por Neto e Mota. A mensagem central do trabalho é que, em plataformas baseadas em mapas, a qualidade da representação espacial é fundamental para transformar dados colaborativos em compreensão territorial e suporte à tomada de decisão. Agradeço à orientadora Marcelle Pereira Mota, ao coorientador André Avelino da Silva Neto, aos membros da banca e a todos que contribuíram para este trabalho. Estou à disposição para perguntas.
...
| Considerações finais | 19–21 | ~2 min |
| **Reserva** | — | **~2 min** |
...
- **Slide 19:** a citação sobre dados georreferenciados é o fechamento emocional do bloco de síntese.
- **Slide 21:** encerre com a **mensagem central** sobre qualidade da representação espacial antes dos agradecimentos.
